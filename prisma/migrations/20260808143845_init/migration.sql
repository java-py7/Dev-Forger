...
-- CreateEnum
CREATE TYPE "ProjectMemberRole" AS ENUM ('OWNER', 'ADMIN', 'DEVELOPER', 'DESIGNER', 'VIEWER');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('PROJECT_INVITATION', 'PROJECT_APPLICATION', 'TEAM_INVITATION', 'TASK_ASSIGNED', 'TASK_UPDATED', 'MESSAGE', 'MENTION', 'DEPLOYMENT', 'SYSTEM');

-- CreateEnum
CREATE TYPE "ConversationType" AS ENUM ('DIRECT', 'PROJECT', 'TEAM');

-- CreateEnum
CREATE TYPE "WorkspaceFileType" AS ENUM ('FILE', 'FOLDER');
...
CREATE TABLE "WorkspaceFile" (
    ...
    "name" TEXT NOT NULL,
    "path" TEXT NOT NULL,
    "type" "WorkspaceFileType" NOT NULL,
    "content" TEXT,
    "language" TEXT,
...
-- CreateIndex
CREATE INDEX "Terminal_workspaceId_idx" ON "Terminal"("workspaceId");

-- CreateIndex
CREATE INDEX "EditorSession_workspaceId_idx" ON "EditorSession"("workspaceId");

-- CreateIndex
CREATE INDEX "EditorSession_userId_idx" ON "EditorSession"("userId");
...
-- CreateIndex
CREATE INDEX "Build_deploymentId_idx" ON "Build"("deploymentId");
...
-- AddForeignKey
ALTER TABLE "ProjectInvitation" ADD CONSTRAINT "ProjectInvitation_senderId_fkey" FOREIGN KEY ("senderId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ProjectInvitation" ADD CONSTRAINT "ProjectInvitation_receiverId_fkey" FOREIGN KEY ("receiverId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Terminal" ADD CONSTRAINT "Terminal_workspaceId_fkey" FOREIGN KEY ("workspaceId") REFERENCES "Workspace"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "EditorSession" ADD CONSTRAINT "EditorSession_workspaceId_fkey" FOREIGN KEY ("workspaceId") REFERENCES "Workspace"("id") ON DELETE CASCADE ON UPDATE CASCADE;
