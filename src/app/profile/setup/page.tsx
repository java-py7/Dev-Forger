...
export default async function ProfileSetupPage() {
  ...
  async function saveProfile(formData: FormData) {
    ...
    const preferredRoleIds = formData.getAll("preferredRole").map(String);
    const lookingForIds = formData.getAll("lookingFor").map(String);
    ...
    const selectedSkillIds = formData.getAll("skillIds").map(String);
      ...
      <div className="mx-auto w-full max-w-5xl px-6 py-10 lg:px-8">
        <div className="mb-10">
          ...
          <p className="mt-2 max-w-2xl text-sm leading-6 text-muted-foreground">
            Tell other developers who you are, what you build,
        ...
        <form action={saveProfile} className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                This information will be visible on your DevForge
                developer profile.
              </CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Add information that helps other developers
                connect with you.
              </CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Select the technologies you know and add your
